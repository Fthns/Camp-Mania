		...
		<div class="login">
			<div class="login__content mt-3">
				<div class="login__head">
					<a href="index.html"><img src="dist/img/Reza_Admin.svg"></a>
					<p class="mt-3">Welcome to Admin</p>
				</div>
				...
				<div class="login__alt">
					<a href="" class="btn btn--login-alt-google mb-2"><span class="fa fa-google"></span> Log in with Google</a>
					<a href="" class="btn btn--login-alt-facebook"><span class="fa fa-facebook"></span> Log in with Facebook</a>
				</div>
			</div>
